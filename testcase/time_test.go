...
func TestBefore(t *testing.T) {
	tm := NewBeijing().Before(3600)
	fmt.Println(tm)
}
func TestNext(t *testing.T) {
	tm := NewBeijing().Next(3600)
	fmt.Println(tm)
}
...
func TestNowTime(t *testing.T) {
	tm := NewBeijing().NowTime()
	fmt.Println(tm)
}

// 2006-01-02T15:04:05Z07:00 转 时间戳
func TestRfcToUnix(t *testing.T) {
	tm := NewBeijing().RfcToUnix("2018-12-12T15:28:16+08:00")
	fmt.Println(tm)
}

// 获取RFC3339格式
func TestGetRFC3339(t *testing.T) {
	tm := NewBeijing().GetRFC3339()
	fmt.Println(tm)
}

// 转换成RFC3339格式
func TestToRFC3339(t *testing.T) {
	tm := NewBeijing().ToRFC3339(NewBeijing().Now())
	fmt.Println(tm)
}
func TestGetFormat(t *testing.T) {
	tm := NewBeijing().GetFormat("YYYYMM")
	fmt.Println(tm)
}
